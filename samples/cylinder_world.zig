...
pub fn main() !void {
    ...
    var floor = rt.Plane{
        .common_attrs = .{
            .material = .{
                ...
                .specular = 0.0,
                .pattern = .{
                    .a = rt.Color{0.5, 0.5, 0.5},
                    .b = rt.Color{0.75, 0.75, 0.75},
    ...
    const big_cylinder = rt.Cylinder{
        .minimum = 0.0,
        .maximum = 0.75,
        .closed = true,
        .common_attrs = .{
    ...
    const glass_cylinder = rt.Cylinder{
        .minimum = 0.0001,
        .maximum = 0.5,
        .closed = true,
        .common_attrs = .{
